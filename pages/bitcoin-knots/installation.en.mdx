...
If you'd like to specify a certain release \(which is recommended\), you can execute the command below. At the moment v29.3.knots20260508 is the latest version of Bitcoin Knots.
