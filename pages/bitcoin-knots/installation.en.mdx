...
If you'd like to specify a certain release \(which is recommended\), you can execute the command below. At the moment v29.2.knots20251110 is the latest version of Bitcoin Knots.
